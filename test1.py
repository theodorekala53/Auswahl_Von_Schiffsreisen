...
# Name: Noubissi Kala Theodore
# Hochschule Worms
# Studiengang: Angewandte Informatik
# Werkstuden beil Diehl Aviation in Frankfurt am Main 
############################################################
...
class HomeWindow:
    def __init__(self, master):
        ...
        l1 = ctk.CTkLabel(master=master, text="Bäcker Home Page", font=('Century Gothic', 30))
